package com.ripper.budding.learning.basic.annotation;

/**
 *
 * @Auther: yingd [RipperF@hotmail.com]
 * @Date:2021-12-06
 * @Description:com.ripper.budding.learning.basic.annotation
 * @Version:1.0
 *
 ...
 *
 * @Inherited
 * 使用@Inherited定义子类是否可继承父类定义的Annotation。@Inherited仅针对@Target(ElementType.TYPE)
 * 类型的annotation有效，并且仅针对class的继承，对interface的继承无效：
 * @Inherited
 * @Target(ElementType.TYPE)
 * public @interface Report {
 *     int type() default 0;
